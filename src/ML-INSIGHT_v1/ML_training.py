...
data = pd.read_csv("/home/vgopal18/python/ML_data/spice_data/results_sw3_100_5p_leak10m.csv", on_bad_lines='warn')
...
#data1 = data1.drop(data1.columns[6],axis=1)
#data1 = data1.drop(data1.columns[4],axis=1)
#data1 = data1.drop(data1.columns[3],axis=1)
#data2 = data2.drop(data2.columns[8],axis=1)
#data2 = data2.drop(data2.columns[7],axis=1)
#data2 = data2.drop(data2.columns[6],axis=1)
#data2 = data2.drop(data2.columns[4],axis=1)
#data2 = data2.drop(data2.columns[3],axis=1)
#data3 = data3.drop(data3.columns[8],axis=1)
#data3 = data3.drop(data3.columns[7],axis=1)
#data3 = data3.drop(data3.columns[6],axis=1)
#data3 = data3.drop(data3.columns[4],axis=1)
#data3 = data3.drop(data3.columns[3],axis=1)
#data4 = data4.drop(data4.columns[8],axis=1)
#data4 = data4.drop(data4.columns[7],axis=1)
#data4 = data4.drop(data4.columns[6],axis=1)
#data4 = data4.drop(data4.columns[4],axis=1)
#data4 = data4.drop(data4.columns[3],axis=1)
...
df = pd.DataFrame(X_test1, columns = data.columns[:6])
df['Actual I'] = Y_test
df.to_csv('test_data.csv', index=False)
df = pd.DataFrame(X_train, columns = data.columns[:6])
df['Actual I'] = Y_train
...
model = Sequential()
model.add(Dense(64, input_dim=6, kernel_initializer='he_uniform', activation='relu'))
...
model.save_weights('/home/vgopal18/python/ML_data/model_weights_spice3stage_nocap_l18.h5')
...
df = pd.DataFrame(X_test1, columns = data.columns[:3])
df['Actual I'] = Y_test
